...
$args = array( 'labels' => $labels, 'hierarchical' => true, 'label' => $i[2], 'show_ui' => true, 'query_var' => true, 'rewrite' => array( 'slug' => __('kataskevastiki-kerkyra-yphresies','techno') ), 'show_admin_column' => false, 'show_in_rest' => true);
