...
$actions=array(array('Partners','Partner','krf_partners',array('krf_projects'),__('partners','techno')), array('Categories','Category','krf_project_cat',array('krf_projects'),__('type','techno')));
...
$args = array( 'labels' => $labels, 'hierarchical' => true, 'label' => $i[2], 'show_ui' => true, 'query_var' => true, 'rewrite' => array( 'slug' => __('kataskevastiki-kerkyra-yphresies-'.$i[4],'techno') ), 'show_admin_column' => false, 'show_in_rest' => true);
